<?php
//INCLUDE HELPER FILES FOR SECURITY
 require_once($_SERVER['DOCUMENT_ROOT'] . '/outreach/lib/htmlout.php');
 require_once($_SERVER['DOCUMENT_ROOT'] . '/outreach/lib/stripslashes.php');
?>
